...
class SpotRewardsCfg:
    ...
    undesired_contacts = RewardTermCfg(
        ...
        weight=-1.0,
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="body"), "threshold": 0.1},
    )
...
class SpotTerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names="body"), "threshold": 5.0},
    )
